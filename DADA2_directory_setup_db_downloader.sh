...
mkdir <analysisName> <analysisName>/tables <analysisName>/plots <analysisName>/data <analysisName>/taxonomy <analysisName>/taxonomy/database <analysisName>/taxonomy/objects
